...
const WeatherTenDays = ({lat,lng, active}) => {
    let [data, setData] = useState(null)
    function getWeather(lat, lng) {
        fetch(`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lng}&hourly=temperature_2m,weathercode,windspeed_10m&forecast_days=14&timezone=Europe%2FMoscow`)
    ...
    return (
        <div className={`tendays_weather ${active}`}>
